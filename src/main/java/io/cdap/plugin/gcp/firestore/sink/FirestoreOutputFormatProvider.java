...
public class FirestoreOutputFormatProvider implements OutputFormatProvider {
   ...
   */
  public FirestoreOutputFormatProvider(String project, String databaseName, @Nullable String serviceAccountFilePath, @Nullable String serviceAccountJson, String serviceAccountType,
